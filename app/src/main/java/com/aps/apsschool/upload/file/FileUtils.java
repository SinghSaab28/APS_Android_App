package com.aps.apsschool.upload.file;
...
import com.aps.apsschool.upload.Config;
import com.aps.apsschool.upload.VideoCompressorApplication;
...
public class FileUtils {
    ...
    public static File saveTempFile(String fileName, Context context, Uri uri) {
        ...
        try {
            ...
            VideoCompressorApplication vca = new VideoCompressorApplication();
            vca.onCreate();
