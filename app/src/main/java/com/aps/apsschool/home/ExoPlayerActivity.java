...
public class ExoPlayerActivity extends AppCompatActivity implements Player.EventListener {
    ...
    ProgressBar spinnerVideoDetails=null;
...
//        if (getIntent().hasExtra(KEY_VIDEO_URI)) {
            videoUri = "https://firebasestorage.googleapis.com/v0/b/fiery-muse-287609.appspot.com/o/lectures%2FVIDEO_20201005_212308.mp4?alt=media&token=c669950b-5b5b-446d-86fa-5e269c24e621";;
//        }
        setUp();
    }
    private void setUp() {
